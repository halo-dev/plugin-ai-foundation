  ...
  >
    <ProviderForm
      ...
      :form-state="{
        ...
        chatEndpointPath: provider.spec.chatEndpointPath,
        embeddingEndpointPath: provider.spec.embeddingEndpointPath,
        rerankEndpointPath: provider.spec.rerankEndpointPath,
        imageEndpointPath: provider.spec.imageEndpointPath,
        apiKeySecretName: provider.spec.apiKeySecretName,
        proxyHost: provider.spec.proxyHost,
        proxyPort: provider.spec.proxyPort,
        maxInMemorySize: provider.spec.maxInMemorySize,
