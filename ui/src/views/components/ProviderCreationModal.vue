    ...
    return await aiConsoleApiClient.provider.createProvider({
      aiProvider: {
        ...
        spec: {
          ...
          chatEndpointPath: formState.chatEndpointPath,
          embeddingEndpointPath: formState.embeddingEndpointPath,
          rerankEndpointPath: formState.rerankEndpointPath,
          imageEndpointPath: formState.imageEndpointPath,
          proxyHost: formState.proxyHost,
          proxyPort: formState.proxyPort,
          maxInMemorySize: formState.maxInMemorySize,
