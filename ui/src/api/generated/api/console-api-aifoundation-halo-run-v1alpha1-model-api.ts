...
// @ts-ignore
import type { TestImageGenerationRequest } from '../models';
// @ts-ignore
import type { TestImageGenerationResponse } from '../models';
// @ts-ignore
...
export const ConsoleApiAifoundationHaloRunV1alpha1ModelApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Test image generation with prompt, optional input images, and diagnostics.
         * @param {string} name Image generation model name (AiModel.metadata.name)
         * @param {TestImageGenerationRequest} testImageGenerationRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        testModelImageGeneration: async (name: string, testImageGenerationRequest: TestImageGenerationRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('testModelImageGeneration', 'name', name)
            // verify required parameter 'testImageGenerationRequest' is not null or undefined
            assertParamExists('testModelImageGeneration', 'testImageGenerationRequest', testImageGenerationRequest)
            const localVarPath = `/apis/console.api.aifoundation.halo.run/v1alpha1/models/{name}/test-image-generation`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(testImageGenerationRequest, localVarRequestOptions, configuration)
...
export const ConsoleApiAifoundationHaloRunV1alpha1ModelApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async testModelImageGeneration(name: string, testImageGenerationRequest: TestImageGenerationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TestImageGenerationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.testModelImageGeneration(name, testImageGenerationRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ConsoleApiAifoundationHaloRunV1alpha1ModelApi.testModelImageGeneration']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Test structured object generation with plain JSON text stream response.
...
export const ConsoleApiAifoundationHaloRunV1alpha1ModelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Test image generation with prompt, optional input images, and diagnostics.
         * @param {ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGenerationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        testModelImageGeneration(requestParameters: ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGenerationRequest, options?: RawAxiosRequestConfig): AxiosPromise<TestImageGenerationResponse> {
            return localVarFp.testModelImageGeneration(requestParameters.name, requestParameters.testImageGenerationRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Test structured object generation with plain JSON text stream response.
...
/**
 * Request parameters for testModelImageGeneration operation in ConsoleApiAifoundationHaloRunV1alpha1ModelApi.
 * @export
 * @interface ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGenerationRequest
 */
export interface ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGenerationRequest {
    /**
     * Image generation model name (AiModel.metadata.name)
     * @type {string}
     * @memberof ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGeneration
     */
    readonly name: string

    /**
     * 
     * @type {TestImageGenerationRequest}
     * @memberof ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGeneration
     */
    readonly testImageGenerationRequest: TestImageGenerationRequest
}
...
export class ConsoleApiAifoundationHaloRunV1alpha1ModelApi extends BaseAPI {
     ...
     * @memberof ConsoleApiAifoundationHaloRunV1alpha1ModelApi
     */
    public testModelImageGeneration(requestParameters: ConsoleApiAifoundationHaloRunV1alpha1ModelApiTestModelImageGenerationRequest, options?: RawAxiosRequestConfig) {
        return ConsoleApiAifoundationHaloRunV1alpha1ModelApiFp(this.configuration).testModelImageGeneration(requestParameters.name, requestParameters.testImageGenerationRequest, options).then((request) => request(this.axios, this.basePath));
    }
