...
## Purpose
Define the model types, capabilities, invocation adapters, discovery evidence, and effective
runtime behavior used to configure and invoke AI models without exposing provider-native types.
