...
- [x] 1.2 Document `EmbeddingRequest` fields as the Java equivalent of provider-neutral embedding settings: provider options, parallel requests, retries, timeout/cancellation, and custom headers
