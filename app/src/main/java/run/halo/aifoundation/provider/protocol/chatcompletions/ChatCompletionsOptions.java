...
public class ChatCompletionsOptions implements ToolCallingChatOptions {
    ...
    private ChatCompletionsOptions(Builder builder) {
    ...
    public static class Builder implements ToolCallingChatOptions.Builder<Builder> {
        ...
        public Builder toolContext(@Nullable Map<String, Object> context) {
            this.toolContext = context != null ? new HashMap<>(context) : null;
            return this;
        }
        ...
        @Override
        public ChatCompletionsOptions build() {
            return new ChatCompletionsOptions(this);
        }
    }
}
